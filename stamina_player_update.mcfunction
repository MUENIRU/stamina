...
execute as @a[scores={Operator=0,tag-spectator=0}] run scoreboard players operation @s tag-StaminaUsedValue += @s tag-WalkDistance
execute as @a[scores={Operator=0,tag-spectator=0}] run scoreboard players operation @s tag-StaminaUsedValue += @s tag-DashDistance
execute as @a[scores={Operator=0,tag-spectator=0}] run scoreboard players operation @s tag-StaminaUsedValue += @s tag-FlyDistance
execute as @a[scores={Operator=0,tag-spectator=0}] run scoreboard players operation @s tag-JumpCount *= @s tag-JumpCountWeight
execute as @a[scores={Operator=0,tag-spectator=0}] run scoreboard players operation @s tag-StaminaUsedValue += @s tag-JumpCount
execute as @a[scores={Operator=0,tag-spectator=0}] run scoreboard players operation @s tag-StaminaUsedValue += @s tag-ClimbDistance
execute as @a[scores={Operator=0,tag-spectator=0}] run scoreboard players operation @s tag-StaminaUsedValue += @s tag-SwimDistance
execute as @a[scores={Operator=0,tag-spectator=0}] run scoreboard players operation @s tag-StaminaUsedValue += @s tag-WalkOnWaterDistance
execute as @a[scores={Operator=0,tag-spectator=0}] run scoreboard players operation @s tag-StaminaUsedValue += @s tag-WalkUnderWaterDistance

# subtruct used stamina value from participants' stamina
execute as @a[scores={Operator=0,tag-spectator=0}] run scoreboard players operation @s tag-stamina -= @s tag-StaminaUsedValue

# give penalties if stamina is 0 or less
execute as @a[scores={Operator=0,tag-spectator=0}] if score @s tag-stamina <= @s tag-StaminaMin run effect give @s slowness 3 255 true
execute as @a[scores={Operator=0,tag-spectator=0}] if score @s tag-stamina <= @s tag-StaminaMin run effect give @s blindness 3 255 true
